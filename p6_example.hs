...
--here , represent the nested loop 
--main = print(l3)
...
--so the number is prime if and only if its 
--main = print(l15)
primecheak1::Int ->Bool
primecheak1 x =length([a | a<-[1..x],x `mod` a==0])==2

--main=print(primecheak1 7)
...
--main =print(unzip[(1,2),(3,4),(5,6)]) ->([1,3,5],[2,4,6])
